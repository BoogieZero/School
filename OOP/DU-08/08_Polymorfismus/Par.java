 ...
 * @version 5.11.2014
 */
public class Par implements IKresleny, IPosuvny, IZvyrazneny
{
   /**
    ...
    */
   public int getVyska(){
       int vyskaMuz = muz.getVyska();
       int vyskaZena = zena.getVyska();
       if(vyskaMuz>vyskaZena){
           return vyskaMuz;
       }else{
           return vyskaZena;
       }
    ...
    */
   public int getSirka(){
       return zena.getSirka()+muz.getSirka();
   }
