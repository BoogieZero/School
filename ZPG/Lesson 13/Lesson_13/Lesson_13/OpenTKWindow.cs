...
namespace Lesson_13 {
    class OpenTKWindow : GameWindow {
        ...
        //Fonts
        private const String PATH_FONTS = "Data/Fonts/";
        private const String FNT_COURIER = "cour.ttf";
        QFont myFnt;
        QFontDrawing fntDrawing;
        ...
        protected override void OnRenderFrame(FrameEventArgs e) {
            ...
            /*
            fntDrawing.DrawingPimitiveses.Clear();
            fntDrawing.Print(myFnt, "Suck my Jim", new Vector3(0f, 0f, -3f), QFontAlignment.Left);
            */
            SwapBuffers();
        }
        ...
        private void genFont() {
            GDIFont fnt = new GDIFont("Data/Fonts/HappySans.ttf", 16, FontStyle.Bold);
            QFont fff = new QFont(fnt);
            QFont.CreateTextureFontFiles("Data/Fonts/HappySans.ttf", 16, "Data/Fonts/TEEEEE", new QFontBuilderConfiguration());
