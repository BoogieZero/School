...
namespace KPG01_ciste
{
    public partial class Form1 : Form
    {
        ...
        private void panel1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            //if(e.Button == MouseButtons.Left && checkBox3.Checked) {
            //    showPixelColorImage(e);
            //}
            ...
            else if (e.Button == MouseButtons.Left && checkBox2.Checked)
            {
                ...
                showPixelColorImage(e);
                vybranaBarva = bmp.GetPixel((int)relativePosition.X, (int)relativePosition.Y);          //vrati pixel na pozici relativePosition
        ...
        {
            //prepocet relativni pozice - nalezeni, kde se kurzor pohybuje po bitmape
            //relativePosition.X = .........
            //relativePosition.Y = .........
        ...
        private void showPixelColorImage(MouseEventArgs e) {
            //graphics.FillRectangle(new SolidBrush(Color.Red), (float)e.X, (float)e.Y, 20, 20);
            Point clickedInPanel = e.Location;
            double x, y;

            relativePosition.X = e.X * ((float)bmp.Width / (float)panel1.Width);
            relativePosition.Y = e.Y * ((float)bmp.Height / (float)panel1.Height);

            //graphics.FillRectangle(new SolidBrush(Color.Red), (float)x, (float)y, 20, 20);
            vykresliDoPanelu();
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            graphics = Graphics.FromImage(bmp);
            myPixels = bitmapToColorf(bmp);                 //prevod obr. pixelu do float4
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            ...
            //prohod barevne kanaly pixelu v bmp
            //pouzij bmp.getpixel(x,y) a bmp.setpixel(x,y)
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            ...
            //prohod barevne kanaly pixelu v myPixels (tje. ColorF)
            //jedná se o dvourozmerne pole [,]


            //prevod na bmp a vykresleni
