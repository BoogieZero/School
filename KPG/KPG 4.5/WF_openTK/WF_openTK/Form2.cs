...
namespace WF_openTK
{
    public partial class Form2 : Form
    {
        ...
        void render() {
                ...
                mviewdata[0] = Matrix4.CreateRotationY(0.55f * rotation) * Matrix4.CreateRotationX(0.15f * rotation) * Matrix4.CreateTranslation(0.0f, 0.0f, -3.0f) * Matrix4.CreatePerspectiveFieldOfView(1.3f, ClientSize.Width / (float)ClientSize.Height, 1.0f, 40.0f);
