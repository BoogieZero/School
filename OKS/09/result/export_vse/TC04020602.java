...
public class TC04020602 {
  ...
  @Test
  public void testTC04020602() throws Exception {
    driver.findElement(By.id("generovani")).click();
    // TC.04.02.06.02 Zahraniční student ANO
    new Select(driver.findElement(By.id("fakulta"))).selectByVisibleText("FST - Fakulta strojní");
    ...
    try {
      assertEquals("S15B0001PI", driver.findElement(By.id("vysledek")).getText());
    } catch (Error e) {
      verificationErrors.append(e.toString());
    }
  }
